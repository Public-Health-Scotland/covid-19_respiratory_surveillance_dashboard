...
# use until lab data new generated on a Tues. Need to change the dates to previous week's folder date  yahdeya
...
# only used between Mon and TUes before dashboard ran
