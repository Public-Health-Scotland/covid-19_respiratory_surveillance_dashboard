               ...
               navlistPanel(widths = c(2,10), id = "respiratory_pathogens_panel", #icon = icon_no_warning_fn("spa")
                            ...
                            tabPanel(title = "COVID-19",
                                     ...
                                     radioGroupButtons("covid19_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", 
                                                                   "Hospital admissions", "Hospital occupancy",
                                                                   "Archive"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.covid19_select=='Laboratory surveillance'",
                            ...
                            tabPanel(title = "Influenza",
                                     ...
                                     radioGroupButtons("influenza_select", status = "home",
                                                       ...
                                                       choices = c("Laboratory surveillance (all Influenza)", "Laboratory surveillance (by subtype)", "CARI community surveillance", "Hospital admissions", "Hospital occupancy"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.influenza_select=='Laboratory surveillance (all Influenza)'",
                                                      column(12, source(file.path("indicators/respiratory_mem/influenza/influenza_mem_ui.R"), local = TRUE)$value)),
                                     conditionalPanel(condition="input.influenza_select=='Laboratory surveillance (by subtype)'",
                                     ...
                                     conditionalPanel(condition="input.influenza_select=='Hospital occupancy'",
                                                      column(12, source(file.path("indicators/respiratory_mem/influenza/influenza_occupancy_ui.R"), local = TRUE)$value)),
                            ...
                            tabPanel(title = "RSV",
                                     ...
                                     radioGroupButtons("rsv_select", status = "home",
                                                       ...
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions", "Hospital occupancy"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.rsv_select=='Laboratory surveillance'",
                                     ...
                                     conditionalPanel(condition="input.rsv_select=='Hospital occupancy'",
                                                      column(12, source(file.path("indicators/respiratory_mem/rsv/rsv_occupancy_ui.R"), local = TRUE)$value)),
                            ...
                            tabPanel(title = "Adenovirus",
                                     ...
                                     radioGroupButtons("adenovirus_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.adenovirus_select=='Laboratory surveillance'",
                                                      column(12, source(file.path("indicators/respiratory_mem/adenovirus/adenovirus_mem_ui.R"), local = TRUE)$value)),
                                     conditionalPanel(condition="input.adenovirus_select=='Hospital admissions'",
                                                      column(12, source(file.path("indicators/respiratory_mem/adenovirus/adenovirus_admissions_ui.R"), local = TRUE)$value)),
                            ...
                            tabPanel(title = "HMPV",
                                     ...
                                     radioGroupButtons("hmpv_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.hmpv_select=='Laboratory surveillance'",
                            ...
                            tabPanel(title = "Mycoplasma pneumoniae",
                                     ...
                                     radioGroupButtons("mycoplasma_pneumoniae_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.mycoplasma_pneumoniae_select=='Laboratory surveillance'",
                            ...
                            tabPanel(title = "Parainfluenza",
                                     ...
                                     radioGroupButtons("parainfluenza_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.parainfluenza_select=='Laboratory surveillance'",
                            ...
                            tabPanel(title = "Rhinovirus",
                                     ...
                                     radioGroupButtons("rhinovirus_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.rhinovirus_select=='Laboratory surveillance'",
                            ...
                            tabPanel(title = "Other seasonal coronaviruses",
                                     ...
                                     radioGroupButtons("seasonal_coronavirus_select", status = "home",
                                                       choices = c("Laboratory surveillance", "CARI community surveillance", "Hospital admissions"),
                                                       direction = "horizontal", justified = F),
                                     conditionalPanel(condition="input.seasonal_coronavirus_select=='Laboratory surveillance'",
...
server <- function(input, output, session) {
  ...
  source(file.path("indicators/at_a_glance/at_a_glance_functions.R"), local = FALSE)$value
  ...
  source(file.path("indicators/respiratory_mem/influenza/influenza_occupancy_server.R"), local = TRUE)$value
  ...
  source(file.path("indicators/respiratory_mem/rsv/rsv_occupancy_server.R"), local = TRUE)$value
