  ...
  div(
    ...
    fluidRow(width=12,
             ...
             popify(bsButton("click",
                    ...
                    content = paste(strong("b"),
                                    "break in time series<br>",
                                    strong("c"),
                                    "confidential<br>",
                                    strong("†"),
                                    "earliest revision<br>",
                                    strong("e"),
                                    "estimated<br>",
                                    strong("f"),
                                    "forecast<br>",
                                    strong("~"),
                                    "less than half the final digit shown and different from a real zero<br>",
                                    strong("u"),
                                    "low reliability<br>",
                                    strong("z"),
                                    "not applicable<br>",
                                    ...
                                    strong("***"),
                                    "significant at 0.001 level<br>",
                                    strong("d"),
                                    "derived<br>",
                                    strong("x"),
                                    "archived or expired<br>",
                                    strong("y"),
                                    "incomplete<br>",
                                    "<br>",
