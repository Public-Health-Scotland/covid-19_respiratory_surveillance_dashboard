tagList(h1("Metadata"),
  bsCollapse(id="notes_collapse", open = "Panel 1",
                   bsCollapsePanel("Cases",
                                   ...
                                   p("The Office for National Statistics (ONS) publish results from the COVID-19 Infection Survey which aims to estimate how many people
                                     test positive for COVID-19 infection at a given point. The ONS survey results are Scotland’s current best understanding of
                                   ...
                                   p(strong("Source:",
                                     tags$a("COVID-19 Modelling the Epidemic", href="https://www.gov.scot/collections/coronavirus-covid-19-modelling-the-epidemic/"))),
                                   br(),
                                   h4("Wastewater"),
      ...
      to ICU, or who has tested positive from the date of admission up to and including the date of ICU discharge. "),
            ...
            As a result, the COVID-19 positive ICU patients could be underreported by up to 10%.")),
                   bsCollapsePanel("Hospital Occupancy",
                                   ...
                                   p("Number of patients in hospital with recently confirmed COVID-19, identified by their first positive LFD test (from 5 January 2022) or PCR test.
                                     This measure (available from 11 September 2020 and first published 15 September 2020) includes patients who first tested positive in hospital or in the 14 days before admission.
                                   ...
                                   p("This is based on the number of patients in beds at 8am the day prior to reporting, with the data extract taken at 8am on the day of reporting to allow 24 hours
                                     for test results to become available. If boards have not submitted by 8am on Monday, the most recent available data will be rolled over and used as a proxy for the missing dates.
                                     Where a patient has not yet received a positive test result they will not be included in this figure. Patients who have been in hospital for more than 28 days and
                                     still being treated for COVID-19 will stop being included in this figure after 28 days."),
                                   ...
                                   p("SARS-CoV-2 PCR +ve with non-COVID-19/unknown diagnosis comprises patients with a positive SARS-CoV-2 PCR test who have been admitted with a non-COVID-19 clinical diagnosis
                                     or missing diagnosis recorded in WardWatcher at the time of data extraction. Less than 5% of all patients in this group have an unknown diagnosis at the time of data extraction,
                                     although this proportion is likely to be higher in the most recent week."),
                                   p("Non-COVID-19 clinical diagnosis comprises patients with a negative SARS-CoV-2 PCR test and who have been admitted with a non-COVID-19 clinical diagnosis recorded in WardWatcher."),
                                   p("Unknown clinical diagnosis comprises patients with a negative SARS-CoV-2 PCR test who are missing a clinical diagnosis recorded in WardWatcher at the time of data extraction.
                                     Please see the most recent",
                                     tags$a("Scottish Intensive Care Society Audit Group COVID-19 report", href = "https://publichealthscotland.scot/publications/show-all-releases?id=20581"), "for more information."),
                                   p(strong("Source:"))),
