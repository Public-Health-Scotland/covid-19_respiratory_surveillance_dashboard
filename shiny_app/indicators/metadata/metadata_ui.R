             ...
             bsCollapsePanel("RSV",
                ...
                bsCollapsePanel("Syndromic Surveillance",
                          ...
                          p("Since 1972, rates of ILI seen by general practitioners have been monitored every week across Scotland. 
                            ...
                            Consultation rates are monitored on a Scotland-wide level, with additional breakdowns by age group and by Health Board."),
                          p("Typically, around 923 practices (98% of all practices in Scotland) routinely report to PHS. 
                            Since August 2009 and up to week 34 2017, almost all practices in Scotland (98%) have submitted electronic consultation data to Public Health Scotland (PHS) every day. 
                            From week 35 2017, practices changed to submission of consultation data on a weekly basis. 
                            The extract is automatically generated in each practice based on the previous week’s consultations for ILI and ARI. 
                            Consultations for ILI and acute respiratory infection (ARI) are identified by searching for ILI or ARI specific Read codes, generated by, and stored in the practice software system."),
                            ...
                            p("A technical document on reporting rates of ILI consultations from General Practitioners in Scotland has been published on our website. 
                            This report provides background to reporting of primary care consultation rates for ILI in Scotland plus: (1) a description of the 2017/18 data issues and end of season revision of ILI consultation rates;
                            and (2) the application of the Moving Epidemic Method (MEM) to Scottish ILI consultation rate data."),
