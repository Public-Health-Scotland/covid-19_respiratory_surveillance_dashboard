...
adenovirus_seasons <- Respiratory_Pathogens_MEM_Scot %>%
  ...
  distinct() %>%
  tail(6)
adenovirus_seasons <- adenovirus_seasons$Season


altTextServer("adenovirus_mem_modal",
              title = "Laboratory-confirmed adenovirus incidence rate per 100,000 population",
...
altTextServer("adenovirus_mem_hb_modal",
              title = "Laboratory-confirmed adenovirus incidence per 100,000 population by NHS Health Board",
              content = tags$ul(tags$li(glue("This is a plot showing the rate of laboratory-confirmed adenovirus infection per 100,000 population by NHS Health Board for seasons ",
                                             adenovirus_seasons[5], " and ", adenovirus_seasons[6], ".")),
                                tags$li("The x axis shows the ISO week of sample, from week 40 to week 39. ",
                                        "Week 40 is typically the start of October and when the winter respiratory season starts."),
...
altTextServer("adenovirus_mem_age_modal",
              title = "Laboratory-confirmed adenovirus incidence per 100,000 population by age group",
              content = tags$ul(tags$li(glue("This is a plot showing the rate of laboratory-confirmed adenovirus infection per 100,000 population by age group for seasons ",
                                             adenovirus_seasons[5], " and ", adenovirus_seasons[6], ".")),
                                tags$li("The x axis shows the ISO week of sample, from week 40 to week 39. ",
