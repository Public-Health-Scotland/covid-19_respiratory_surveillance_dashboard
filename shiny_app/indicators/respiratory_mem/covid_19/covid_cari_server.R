...
altTextServer("covid_cari_modal",
              title = "CARI - Swab positivity for COVID-19",
              content = tags$ul(tags$li("This is a plot showing the swab positivity rate of COVID-19 infection in the Community Acute Respiratory Infection (CARI) surveillance programme."),
...
altTextServer("covid_cari_age_modal",
              title = "CARI - Swab positivity for COVID-19 by age group",
              content = tags$ul(tags$li("This is a plot showing the swab positivity rate of COVID-19 infection by age group in the Community Acute Respiratory Infection (CARI) surveillance programme."),
                                tags$li("The x axis is the week ending date, starting 09 October 2022."),
                                tags$li("The y axis is the swab positivity rate."),
