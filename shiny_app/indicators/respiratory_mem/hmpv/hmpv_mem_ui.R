tagList(
  ...
  fluidRow(width = 12,
           tagList(h2("Laboratory-confirmed HMPV incidence per 100,000 population in Scotland"))),
  ...
  fluidRow(width = 12,
           tagList(h2("Laboratory-confirmed HMPV incidence per 100,000 population by NHS Health Board"))),
  # 
  fluidRow(
  ...
  fluidRow(width = 12,
           tagList(h2("Laboratory-confirmed HMPV incidence per 100,000 population by age group"))),
