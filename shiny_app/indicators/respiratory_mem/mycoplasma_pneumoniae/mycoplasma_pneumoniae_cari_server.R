...
altTextServer("mycoplasma_pneumoniae_cari_age_modal",
              title = "CARI - Test positivity for Mycoplasma Pneumoniae by age group",
              content = tags$ul(tags$li("This is a plot showing the test positivity rate of Mycoplasma pneumoniae infection by age group in the Community Acute Respiratory Infection (CARI) surveillance programme."),
                                tags$li("The x axis is the week ending date, starting 09 October 2022."),
                                tags$li("The y axis is the test positivity rate."),
