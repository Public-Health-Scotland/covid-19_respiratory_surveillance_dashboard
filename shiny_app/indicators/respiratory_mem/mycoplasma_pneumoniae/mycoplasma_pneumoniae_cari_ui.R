...
tagList(
  ...
  fluidRow(width = 12,
           tabPanel(stringr::str_to_sentence("mycoplasma_pneumoniae"),
                    ...
                    tagList(h2(glue("Mycoplasma pneumoniae test positivity in the Community Acute Respiratory Infection (CARI) sentinel surveillance programme")),
  ...
  fluidRow(width = 12,
           tagList(h2("CARI - Test positivity for Mycoplasma pneumoniae"))),
