...
tagList(
  ...
  fluidRow(width = 12,
           tabPanel(stringr::str_to_sentence("rhinovirus"),
                    ...
                    tagList(h2(glue("Summary of Rhinovirus swab positivity in the Community Acute Respiratory Infection (CARI) sentinel surveillance programme")),
  ...
  fluidRow(width = 12,
           tagList(h2("CARI - Swab positivity for Rhinovirus"))),
  ...
  fluidRow(width = 12,
           tagList(h2("CARI - Swab positivity for Rhinovirus by age group"))),
