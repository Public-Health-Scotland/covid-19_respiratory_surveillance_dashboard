...
altTextServer("seasonal_coronavirus_cari_modal",
              title = "CARI - Swab positivity for Seasonal Coronavirus",
              content = tags$ul(tags$li("This is a plot showing the swab positivity rate of Seasonal Coronavirus infection in the Community Acute Respiratory Infection (CARI) surveillance programme."),
...
altTextServer("seasonal_coronavirus_cari_age_modal",
              title = "CARI - Swab positivity for Seasonal Coronavirus by age group",
