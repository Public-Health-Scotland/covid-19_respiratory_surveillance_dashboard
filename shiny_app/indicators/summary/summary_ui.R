    ...
    tagList(
      box(height=500, status = "info",
          tagList(
            ...
            infoBox(title=h5("Admissions", bsButton("summary_admissions", class = "summary-btn", label = "", icon = icon("question"), size = "extra-small")),
                    value= admissions_headlines[[1]],
                    subtitle = "Weekly total",
                    icon = icon_no_warning_fn("hospital"),
                    color = "green", width = NULL),
            bsPopover("summary_admissions", "COVID-19 hospital admissions",
