...
altTextServer("gp_mem_modal",
              title = "GP consultations incidence rate per 100,000 population",
              content = tags$ul(tags$li("This is a plot showing the rate of GP consultations per 100,000 population in Scotland."),
                                ...
                                tags$li("The y axis shows the rate of GP consultations per 100,000 population."),
                                ...
                                tags$li(glue("Activity levels for GP consultations based on MEM thresholds are represented by different coloured panels on the plot. ",
...
altTextServer("gp_mem_hb_modal",
              title = "GP consultations incidence rate per 100,000 population by NHS Health Board",
              content = tags$ul(tags$li(glue("This is a plot showing the rate of GP consultations per 100,000 population by NHS Health Board for seasons ",
                                             seasons[6], " and ", seasons[7], ".")),
                                tags$li("The x axis shows the ISO week of sample, from week 40 to week 39. ",
                                        "The first ISO week is the first week of the year (in January) and the 52nd ISO week is the last week of the year."),
...
altTextServer("gp_mem_age_modal",
              title = "GP consultations incidence rate per 100,000 population by age group",
              content = tags$ul(tags$li(glue("This is a plot showing the rate of GP consultations infection per 100,000 population by age group for seasons ",
                                             seasons[6], " and ", seasons[7], ".")),
                                tags$li("The x axis shows the ISO week of sample, from week 40 to week 39. ",
                                        "The first ISO week is the first week of the year (in January) and the 52nd ISO week is the last week of the year."),
