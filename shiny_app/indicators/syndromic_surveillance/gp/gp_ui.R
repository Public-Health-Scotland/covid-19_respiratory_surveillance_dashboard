tagList(
  fluidRow(width = 12,
           ...
           linebreaks(1),
           h1("GP Consultations Incidence Rates"),
           linebreaks(1)),

  fluidRow(width = 12,
           tagList(h2("GP consultations incidence rate per 100,000 population in Scotland"))),
  ...
  fluidRow(width = 12,
           tagList(h2("GP consultations incidence rate per 100,000 population by NHS Health Board"))),
  ...
  fluidRow(width = 12,
           tagList(h2("GP consultations incidence rate per 100,000 population by age group"))),
